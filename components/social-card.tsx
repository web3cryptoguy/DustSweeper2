    ...
    <div className="space-y-4 sm:space-y-6">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
              <div className="text-center">
                ...
                <div className="text-blue-100 text-xs sm:text-sm">Tokens Swapped</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-blue-100 text-xs sm:text-sm">Total Value</div>
              </div>
            </div>

            <div className="text-center mb-4 sm:mb-6">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 text-sm sm:text-base md:text-lg">
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
        <Button
          ...
          className="flex-1 sm:flex-none sm:max-w-xs bg-transparent text-sm sm:text-base"
        >
          {downloading ? (
            <>
        ...
        <Button onClick={handleShare} className="flex-1 sm:flex-none sm:max-w-xs text-sm sm:text-base">
