...
export default function Navbar({ envStatus }: NavbarProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-orange-100 border-b border-orange-200 w-full">
      <div className="container mx-auto px-3 sm:px-4 py-2 sm:py-3 max-w-full">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4 flex-nowrap justify-end">
              ...
              <>
                <div className="relative" ref={walletMenuRef}>
                  <Button
                    ...
                    variant="default"
                    size="sm"
                    className="flex items-center gap-1.5 sm:gap-2 bg-black text-white hover:bg-gray-800 whitespace-nowrap px-2 sm:px-3 py-1.5 sm:py-2"
                  >
                    <img
                    ...
                    />
                    <span className="font-mono text-xs sm:text-sm truncate max-w-[80px] sm:max-w-none">{formatAddress(address || "")}</span>
                ...
                <div className="relative" ref={networkMenuRef}>
                  <Button
                    ...
                    variant="default"
                    size="sm"
                    className="flex items-center gap-1.5 sm:gap-2 bg-black text-white hover:bg-gray-800 text-xs sm:text-sm whitespace-nowrap px-2 sm:px-3 py-1.5 sm:py-2"
                  >
                    <img
