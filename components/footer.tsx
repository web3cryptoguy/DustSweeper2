      ...
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-2 text-xs sm:text-sm text-gray-600">
          <div className="flex items-center justify-center gap-2 flex-wrap">
            ...
            <span>by</span>
            <a
              href="https://www.quicknode.com/sample-app-library/dustsweeper-eip-7702"
              target="_blank"
            ...
            <a
              href="https://github.com/quiknode-labs/qn-guide-examples/tree/main/sample-dapps/dustsweeper-eip-7702"
              target="_blank"
              rel="noopener noreferrer"
