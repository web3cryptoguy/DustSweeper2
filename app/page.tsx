...
export default function DustSweeperApp() {
  ...
  if (!isConnected) {
    return (
      <div className="flex flex-col min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 w-full overflow-x-hidden">
        <div className="flex-1 container mx-auto px-3 sm:px-4 pt-8 sm:pt-16 pb-4 sm:pb-6 max-w-full">
  ...
  if (swapStep === "success" && swapResult) {
    return (
      <div className="flex flex-col min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 w-full overflow-x-hidden">
        <div className="flex-1 container mx-auto px-3 sm:px-4 pt-6 sm:pt-8 md:pt-16 pb-4 sm:pb-6 max-w-full">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100 w-full">
      <main className="flex-1 container mx-auto px-0 sm:px-4 md:px-6 pt-3 sm:pt-4 md:pt-8 pb-4 sm:pb-6 w-full">
        {swapStep === "select" && (
